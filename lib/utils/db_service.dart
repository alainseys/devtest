import 'dart:async';
import 'package:doobeedoo/models/db_model.dart';
...
abstract class DB {
  ...
  static void onUpdate(Database db, int version) async {
    await db.execute('UPDATE TABLE radios (id  INTEGER PRIMARY KEY NOT NULL, radioName STRING, radioURL STRING, radioDesc STRING,radioWebsite STRING, radioPic String');
  }
